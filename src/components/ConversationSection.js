                ...
                <div className="bg-[#2E4E8B] radius_custom xl:pb-16 lg:pb-24 md:pb-28">
                    <div className="cols-10 mx-auto">
                        <div className="flex xl:justify-unset lg:justify-unset md:justify-unset sm:justify-center xs:justify-center xxs:justify-center xl:flex-nowrap lg:flex-nowrap md:flex-nowrap sm:flex-wrap xs:flex-wrap xxs:flex-wrap">
                            <div className="grid-cols-1 mt-80 xl:mb-0 lg:mb-0 md:mb-0 sm:mb-2 xs:mb-6 xxs:mb-8  ">
                                <div className="flex justify-center">
                                    <h1 className="xl:text-4xl lg:text-4xl md:text-2xl sm:text-2xl xs:text-xl xxs:text-lg font-semibold xl:w-[60%] lg:w-[60%] md:w-[67%] text-white xl:px-0 lg:px-0 md:px-0 sm:px-14 xs:px-12 xxs:px-12">
                                        More than 80% of small businesses report gaining their customers via word-of-mouth.<br />
                                        <i>Join the conversation.</i>
                                    </h1>
                                </div>
                                <div className="xl:mt-24 lg:mt-24 md:mt-24 sm:mt-12 xs:mt-8 xxs:mt-6 xl:ml-40 lg:ml-32 md:ml-16 flex xl:justify-start lg:justify-start md:justify-start sm:justify-center xs:justify-center xxs:justify-center">
                                    <button className="bg-white hover:bg-gray-100 py-3 px-14 rounded-full shadow text-xl font-semibold text-[#101F55]">
                                        Start for free
                                    </button>
                                </div>
                            </div>
