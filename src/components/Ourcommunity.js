                            ...
                            <div className="grid lg:grid-cols-4 place-items-center gap-10 xl:pb-[170px] lg:pb-[120px] md:pb-[280px] sm:pb-[300px] xs:pb-[320px] xxs:pb-[320px]">
                                <div className="col-span-2">
                                    <div className='community_section xl:pt-0 lg:pt-0 md:pt-16 sm:pt-24 xs:pt-32 xxs:pt-32'>
                                        <h1 className='xl:text-5xl lg:text-5xl md:text-5xl sm:text-4xl xs:text-4xl text-third-section font-bold xl:text-unset lg:text-unset md:text-unset sm:text-unset xs:text-unset xxs:text-center'>Our community <br></br>says it best</h1>
                                        <p className='mt-10 xl:text-xl lg:text-xl md:text-xl sm:text-xl xs:text-lg font-semibold text-third-section'><strong>94% of UpGrowth users </strong>would <br />recommend UpGrowth to a friend</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="border rounded-lg bg-white shadow w-4/5 card_custom xl:mt-[15%] lg:mt-[1%] xl:ml-0 lg:ml-0 md:ml-4">
                                        <div className="flex p-6 gap-4 items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-justify mt-4 xl:text-base lg:text-base md:text-base sm:text-sm xs:text-xs xxs:text-xs font-semibold text-[#4F4F4F]">Dr. Brittany Woodard-Hampton, Founder & CEO Point of Health | Wellness</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border rounded-lg bg-white shadow w-4/5 card_custom">
                                        <div className="flex p-6 gap-4 items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-justify mt-4 xl:text-base lg:text-base md:text-base sm:text-sm xs:text-xs xxs:text-xs font-semibold text-[#4F4F4F]">Khufu Reign, Founder & CEO <br></br> Reignwater | Web3</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border rounded-lg bg-white shadow w-4/5 card_custom xl:ml-0 lg:ml-0 md:ml-4">
                                        <div className="flex p-6 gap-4 items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-justify mt-4 xl:text-base lg:text-base md:text-base sm:text-sm xs:text-xs xxs:text-xs font-semibold text-[#4F4F4F]">Perry, General Manager<br></br> That Bar | Hospitality </p>
                                            </div>
                                        </div>
                                    </div>
